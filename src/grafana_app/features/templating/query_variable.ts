...
import { Variable, containsVariable, variableTypes } from './variable';
...
export class QueryVariable implements Variable {
  ...
  /** @ngInject */
  constructor(private model, private datasourceSrv, private templateSrv, private variableSrv2, private timeSrv) {
  ...
  updateOptions() {
    return this.datasourceSrv
      ...
      .then(this.variableSrv2.validateVariableSelectionState.bind(this.variableSrv2, this));
  }
