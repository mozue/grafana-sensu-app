...
// import { Graph } from 'grafana/app/core/utils/dag';
...
export class VariableSrv2 {
  dashboard: any;
  variables: any[];

  /** @ngInject */
  // constructor(private $q, private $location, private $injector, private templateSrv: any, private timeSrv: any) {}
  constructor(private $q, private $injector, private templateSrv: any, private timeSrv: any) {}
...
angular.module('grafana.services').service('variableSrv2', VariableSrv2);
